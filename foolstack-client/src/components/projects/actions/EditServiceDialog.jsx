...
function EditServiceDialog(props) {
    ...
    useEffect(() => {
        setState({
            ...
            requestMethod: props.service.requestMethod ? props.service.requestMethod : '',
            path: props.service.path ? props.service.path : '',
            sampleResponse: props.service.sampleResponse ? props.service.sampleResponse : {language: '', responseBody: ''},
            queryParams: props.service.queryParams ? props.service.queryParams : [{name: '', type: '', description: '', index: 1}],
            sampleRequests: props.service.sampleRequests ? props.service.sampleRequests : [{language: '', requestBody: '', index: 1}],
            responseFields: props.service.responseFields ? props.service.responseFields : [{name: '', type: '', description: '', index: 1}]
        })
    }, [])
